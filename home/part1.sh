...
sed -i '1i src-git redfrog999 https://github.com/redfrog99/packages.git;openwrt-23.05' feeds.conf.default
cp -rf ../config/diff/* .
...
echo "src-git nkki https://github.com/nikkinikki-org/OpenWrt-nikki" >> "feeds.conf.default"
